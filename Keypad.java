...
public class Keypad implements KeyListener {
    ...
    private Scanner scanner; // additional scanner reference
    ...
    private Screen screen; // reference to Screen for displaying popups                      
    // constructor that accepts optional TextArea

    public Keypad(TextArea textArea) {
        input = new Scanner(System.in);
        this.scanner = input; // Reference to the same scanner
    ...
    // Method to set Screen reference
    ...
    public int getIntInput() {
        ...
        try {
            ...
            if (num < 0) {
                System.out.printf("\nThe number cannot be negative,try remaining;");
                screen.MessagePopup("<html><p align=center>The number cannot be negative.</p></html>");
                return -1;
            }
            return num;
